...
//#include "tools.h"
//
//b::expected<std::nullopt_t,Error> cmake_run(const ProjectData& project) {
//    b::process cmake;
...
//}
//
//b::expected<std::nullopt_t,Error> cli_run(const ProjectData& project) {     // TODO: Add a cache entry and run configure if it hasn't been run yet
//    auto success = cmake_run(project);
//    if (!success) {
