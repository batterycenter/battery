...
namespace b {
    ...
    /// \details This function uses fmt::print under the hood. See https://fmt.dev/latest/syntax.html for more info.
    ///          Example usage: `b::print("Hello, {0}!", "world")`. The format string must be a plain string literal,
