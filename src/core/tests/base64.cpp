...
TEST(BatteryCore_Base64, Base64TextEncode) {
    EXPECT_EQ(b::encode_base64(BASE64_UTF8_TEST), BASE64_UTF8_TEST_ENCODED);
}

TEST(BatteryCore_Base64, Base64TextDecode) {
    EXPECT_EQ(b::decode_base64_text(BASE64_UTF8_TEST_ENCODED), BASE64_UTF8_TEST);
}

TEST(BatteryCore_Base64, Base64BinaryEncode) {
    EXPECT_EQ(b::encode_base64(BASE64_BINARY_TEST), BASE64_BINARY_TEST_ENCODED);
}

TEST(BatteryCore_Base64, Base64BinaryDecode) {
    EXPECT_EQ(b::decode_base64_binary(BASE64_BINARY_TEST_ENCODED).value(), BASE64_BINARY_TEST);
}
