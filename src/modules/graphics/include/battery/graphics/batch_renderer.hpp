...
//        }
        ...
        void drawRect(const b::vec2& pos, const b::vec2& size, sf::Color fillColor, double outlineThickness = 0.f, sf::Color outlineColor = sf::Color::Black);

        void render(sf::RenderTarget& target);

    private:
        void appendSimpleRect(const b::vec2& pos1, const b::vec2& pos2, const b::vec2& pos3, const b::vec2& pos4, sf::Color color);
        void appendSimpleLine(const b::vec2& pos1, const b::vec2& pos2, sf::Color color, double thickness);
