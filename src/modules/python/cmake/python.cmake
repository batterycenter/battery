...
macro(battery_find_python)
    ...
    if (NOT Python_FOUND)
        if (WIN32)
            set(PYTHON_INSTALL_INSTRUCTIONS "https://www.python.org/downloads/")
        else()
            set(PYTHON_INSTALL_INSTRUCTIONS "sudo apt install python3-dev")
        endif()
        message(FATAL_ERROR "Python Interpreter not found. Please install it (${PYTHON_INSTALL_INSTRUCTIONS}), set Python_ROOT_DIR to the install location, or refer to https://cmake.org/cmake/help/latest/module/FindPython.html")
    endif()
