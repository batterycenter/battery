...
namespace Battery {
	namespace ImGuiUtils {
		...
		ImGuiUtils::ImGuiColors defaultColorScheme;		// Global variable
        ...
        ImFont* AddEmbeddedFontUncompressed(const unsigned int* data, unsigned int length, float pixels) {
            ...
            memcpy_s(temp, length, data, length);   // This buffer is tranferred to ImGui and then deleted by ImGui
