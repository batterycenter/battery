...
)
{
    ...
    outfile << "// Embedded file: " << resource_file.filename().u8string() << " | filesize: "
            << filesize << " bytes | was embedded as binary: " << (binary ? "true" : "false") << "\n";
    outfile << "// Header file containing the declaration for retrieving the data: " << resource_file.filename().u8string() << ".h\n";
...
)
{
    ...
    file << "// Embedded file: " << resource_file.filename().u8string() << " | filesize: "
         << filesize << " bytes | was embedded as binary: " << (binary ? "true" : "false") << "\n";
    file << "// Source file containing the data: " << resource_file.filename().u8string() << ".cpp\n";
